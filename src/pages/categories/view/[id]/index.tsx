...
import { useCategoryFindFirst, useRoqClient } from 'lib/roq';
...
function CategoryViewPage() {
  ...
  const { data, error, isLoading } = useCategoryFindFirst(queryParams, {}, { disabled: !id });
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="Category Status" text={data?.category_status} />
