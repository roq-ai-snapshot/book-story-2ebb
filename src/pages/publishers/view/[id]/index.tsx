...
import { usePublisherFindFirst, useRoqClient } from 'lib/roq';
...
function PublisherViewPage() {
  ...
  const { data, error, isLoading } = usePublisherFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('publisher', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/publishers/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="publisher" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
              ...
              >
                ...
                <FormListItem label="Publisher Status" text={data?.publisher_status} />

                <FormListItem label="Publisher Type" text={data?.publisher_type} />
