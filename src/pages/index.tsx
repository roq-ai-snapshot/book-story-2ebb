  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Book Story: Unleashing the power of narratives. Your journey to create, share, and discover captivating stories begins here, in our SaaS application."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1495446815901-a7297e633e8d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxib29rc3xlbnwwfHx8fDE2OTc2MTUzNDJ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@tomhermans?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Tom Hermans`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Book Story: Unleashing the power of narratives. Your journey to create, share, and discover captivating stories begins here, in our SaaS application.`}
            </Text>
            <Box
