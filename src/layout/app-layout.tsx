...
import { usePublisherFindFirst } from 'lib/roq';
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const { data, error, isLoading } = usePublisherFindFirst(
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    {
      name: 'Publishers',
      path: isTenantUser ? `/publishers/view/${data?.id}` : '/publishers',
      entity: 'publisher',
      service: AccessServiceEnum.PROJECT,
      icon: FiBookOpen,
    },
    { name: 'Books', path: '/books', entity: 'book', service: AccessServiceEnum.PROJECT, icon: FiBook },
    {
